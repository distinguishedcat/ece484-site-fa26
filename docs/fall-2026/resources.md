...
**Step 3** Once you join the ECE484 Students organization, navigate to the **Repositories** tab where you will be able to view your submission repo `fa26_ece484_YOUR_NETID` and the MP0 release repo with your starter code `fa26-mp0-release`.
